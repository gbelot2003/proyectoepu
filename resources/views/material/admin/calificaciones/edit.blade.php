...
@section('content')
    ...
    {!! Form::model($calificacion, array('route' => array('admin.calificaciones.update', $calificacion->id), 'method' => 'patch', 'files' => 'true')) !!}
    ...
    <div class="row">
        <div class="input-field col m3 s12 @if ($errors->has('details')) has-error @endif">
            {!! Form::select('status', $status, $calificacion->status,  ['class' => 'califica validate']) !!}
        </div>
    </div>
